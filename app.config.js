...
const KAKAO_ADMIN_KEY =
  process.env.EXPO_PUBLIC_KAKAO_ADMIN_KEY || '';
...
export default {
  ...
  extra: {
    ...
    eas: { projectId: '95a7097f-38a0-4814-848d-430a25366eca' },
  },
  ...
  plugins: [
    ...
    // ★ Fabric(새 아키텍처) 켜기 + iOS 정적 프레임워크 + Kakao maven repo
    ...
    // ★ Kakao core 플러그인에 nativeAppKey 전달(빈 값이면 안 됨)
    ['@react-native-kakao/core', { nativeAppKey: KAKAO_NATIVE_APP_KEY }],
  ],
};
